...
exports.AttractionsModule = AttractionsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: attraction_entity_1.Attraction.name, schema: attraction_entity_1.AttractionSchema }])],
        controllers: [attractions_controller_1.AttractionsController],
        providers: [attractions_service_1.AttractionsService],
    })
], AttractionsModule);
